...
class FightersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fighter" do
    assert_difference('Fighter.count') do
      post fighters_url, params: { fighter: { highlight_url: @fighter.highlight_url, image_url: @fighter.image_url, losses: @fighter.losses, name: @fighter.name, wins: @fighter.wins } }, as: :json
    end
  ...
  test "should update fighter" do
    patch fighter_url(@fighter), params: { fighter: { highlight_url: @fighter.highlight_url, image_url: @fighter.image_url, losses: @fighter.losses, name: @fighter.name, wins: @fighter.wins } }, as: :json
    assert_response 200
  end
